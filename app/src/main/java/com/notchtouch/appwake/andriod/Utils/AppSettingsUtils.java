...
public class AppSettingsUtils {
    ...
    public static void gotoUrl(Activity activity) {
        Uri uri = Uri.parse(Functions.PRIVACY_POLICY);
    ...
    public static void setBG(Activity context, int drawable) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") android.graphics.drawable.Drawable background = context.getResources().getDrawable(drawable);
