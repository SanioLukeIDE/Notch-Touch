...
public class Globals {
    ...
    public static void showLoadingDialog(Activity activity) {
        if (!activity.getComponentName().getClassName().equals("com.notchtouch.appwake.andriod.Activities.SplashScreenActivity")) { // Change this classpath according to your SplashScreen Activity
