...
public class Global {
    ...
    public static void showAlertProgressDialog(Activity activity) {
        if (!activity.getComponentName().getClassName().equals("com.notchtouch.appwake.andriod.Activities.SplashScreenActivity")) {
    ...
    public static View getDefaultImage(Context context, Drawable imgRes) {
        ...
        imageView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 600, Gravity.CENTER));
